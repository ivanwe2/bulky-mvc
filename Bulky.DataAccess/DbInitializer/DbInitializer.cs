    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            if (!_roleManager.RoleExistsAsync(RoleConstants.Customer).GetAwaiter().GetResult())
            {
                ...
                _roleManager.CreateAsync(new IdentityRole(RoleConstants.Company)).GetAwaiter().GetResult();
                ...
                _userManager.AddToRoleAsync(user, RoleConstants.Admin).GetAwaiter().GetResult();
